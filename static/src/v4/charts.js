...
export async function initCharts() {
  ...
  const echartsCore = window.echarts;
  if (!echartsCore) {
    console.warn('ECharts was not loaded; charts were skipped.');
    elements.forEach((el) => el.classList.remove('skeleton', 'chart-skeleton'));
    return;
  }
